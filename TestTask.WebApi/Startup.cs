...
namespace TestTask.WebApi
{
    public class Startup
    {
        ...
        {
            services.AddScoped<IGamesRepository, VideoGamesRepository>();
            services.AddScoped<IGamesService, GamesService>();
            
            services.AddDbContext<VideoGamesContext>(
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "TestTask.WebApi", Version = "v1"});
            });
        }
